...
const DEFAULT_AVATAR_URL = "/backgroundflobbi.ico";
  ...
  const handleSaveChanges = () => {
    if (onProfileUpdate && showSettings) {
      ...
      if (!updateData.name || !updateData.handle) {
        alert('Name and handle are required fields');
        return;
      }
      
      onProfileUpdate(updateData);
      
      // Dispatch custom event to notify SearchAndLeaderboard component
